...
"""
    ...
    # Only expose movable (revolute/prismatic/continuous) joints
...
"""
    ...
    return template.render(base_name=base_name)
...
{{ cls }}Control::{{ cls }}Control(QObject *parent)
    : {{ cls }}ControlBase(parent)
{
}
"""
    )
...
"""
    ...
    return template.render(base_name=base_name, joints_name=joints_name)
