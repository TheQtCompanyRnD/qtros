...
#ifndef QROS2_TRANSFORMBROADCASTER_P_H
#define QROS2_TRANSFORMBROADCASTER_P_H
...
class Q_ROS2TRANSFORMS_EXPORT QRos2TransformBroadcaster : public QRos2Entity
{
    Q_OBJECT
    QML_NAMED_ELEMENT(TransformBroadcaster)

public:
    explicit QRos2TransformBroadcaster(QObject* parent = nullptr);
...
#endif // QROS2_TRANSFORMBROADCASTER_P_H
